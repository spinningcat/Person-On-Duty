...
function AppearingSecondDropDown() {
  ...
  $firstDropdown.on('change', function() {
    ...
    if ($(this).find(":selected").text() === "İzleme Sistemleri Yönetimi Alt Gr.") {
    ...
    } else if ($(this).find(":selected").text() === "Sistem Yönetimi ve Veri Saklama Alt Gr.") {
      $secondDropdown.empty();
      $secondDropdown.prop('disabled', false);
    ...
    } else if ($(this).find(":selected").text() === "Network Yazılım Alt Gr.") {
      $secondDropdown.empty();
      $secondDropdown.prop('disabled', false);
